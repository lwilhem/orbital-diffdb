...
export interface ShadcnModuleOptions {
  /**
...
export default defineNuxtModule<ShadcnModuleOptions>({
  meta: {
    name: 'shadcnui',
    configKey: 'shadcnui',
    compatibility: {
  ...
  async setup({ componentDir, prefix }, nuxt) {
    ...
    // early exit if the component directory for shadn registry does not exist

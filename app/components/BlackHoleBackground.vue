...
<template>
  <div
    ...
    class="before:block after:block before:top-1/2 after:top-1/2 before:left-1/2 after:left-1/2 after:z-[5] before:absolute after:absolute relative size-full before:size-[140%] after:size-full overflow-hidden before:content-[''] after:content-[''] before:[background:radial-gradient(ellipse_at_50%_55%,transparent_10%,white_50%)] before:[transform:translate3d(-50%,-50%,0)] dark:before:[background:radial-gradient(ellipse_at_50%_55%,transparent_10%,black_50%)] after:mix-blend-overlay after:[background:radial-gradient(ellipse_at_50%_75%,#a900ff_20%,transparent_75%)] after:[transform:translate3d(-50%,-50%,0)]"
    v-bind="props"
  >
    <slot />
    <canvas
      ref="canvasRef"
      class="block absolute inset-0 opacity-10 dark:opacity-20 size-full"
    />
    <motion.div
      class="top-[-71.5%] left-1/2 z-[3] absolute opacity-75 blur-3xl rounded-b-full w-[30%] h-[140%] mix-blend-plus-darker [background-position:0%_100%] [background-size:100%_200%] [transform:translate3d(-50%,0,0)] dark:mix-blend-plus-lighter [background:linear-gradient(20deg,#00f8f1,#ffbd1e40_16.5%,#fe848f_33%,#fe848f40_49.5%,#00f8f1_66%,#00f8f180_85.5%,#ffbd1e_100%)_0_100%_/_100%_200%] dark:[background:linear-gradient(20deg,#00f8f1,#ffbd1e20_16.5%,#fe848f_33%,#fe848f20_49.5%,#00f8f1_66%,#00f8f160_85.5%,#ffbd1e_100%)_0_100%_/_100%_200%]"
      :animate="{ backgroundPosition: '0% 300%' }"
      :transition="{ duration: 5, ease: 'linear', repeat: Infinity }"
    />
    <div
      class="top-0 left-0 z-[7] absolute opacity-50 size-full mix-blend-overlay dark:[background:repeating-linear-gradient(transparent,transparent_1px,white_1px,white_2px)]"
    />
  </div>
</template>
